...
public class StorageDefinition {
    ...
    public static StorageDefinition getFromString(String completeStorageDefinition) throws ConnectorException {
        try {
            ...
            throw new ConnectorException(BPMNERROR_INCORRECT_STORAGEDEFINITION, message);
        }
    }
